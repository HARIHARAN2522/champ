...
ReportPortal is distributed under the Apache v2.0 license, and it is free to use and modify, even for commercial purposes. We offer two paid premium features – Quality Gates and SCIM Server feature.
...
To explore our capabilities, you can try ReportPortal demo.
