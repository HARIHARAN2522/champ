...
Our platform is **invite-only** and Only Workspace Admins can invite new members.

## How to Join

1. **Contact our organization’s Super Admin**
2. Request an invitation to the platform
3. Once invited, you’ll receive an email with a signup link
4. Complete your profile and start using the app

### If You’re Invited as a Workspace Admin
When a Super Admin invites you with the Admin role, you gain the ability to invite and manage team members within your workspace.
...
You cannot grant permissions outside predefined role boundaries.
